...
module.exports.getProducts = ({ allocationId, sessionId, countryCode, countryCodeTwoLetters,
	continentCode, referer, userAgent }) => ammit({ allocationId, sessionId, countryCodeTwoLetters, continentCode, referer, userAgent }).then(({ abVars, allocation }) => fetch('https://barrier-guru.ft.com/barrier', {
	headers: {
		'country-code': countryCode,
		'x-api-key': apiKey,
		'x-ft-ab': abVars
	}
}).then(json).then(barrier => ({
