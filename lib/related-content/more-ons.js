...
const getMoreOnTags = content => {
	...
	const about = filteredAnnotations.find(annotation => annotation.predicate === 'http://www.ft.com/ontology/annotation/about');
	const primarilyClassifiedBy = filteredAnnotations.find(annotation => annotation.predicate === 'http://www.ft.com/ontology/classification/isPrimarilyClassifiedBy');
	const brand = filteredAnnotations.find(annotation => annotation.types && annotation.types.includes('http://www.ft.com/ontology/product/Brand'));
