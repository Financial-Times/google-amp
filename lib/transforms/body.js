...
module.exports = (body, options = {}) => timePromise('body transform')(Promise.resolve(body).then(replaceEllipses).then(removeLinkWhitespace).then(articleBody => transform(parseDOM(articleBody))).then(renderToString));
