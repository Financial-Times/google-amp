...
describe('interactive graphics transform', () => {
	it('should transform to iframe if href is https', async () => {
		expect(
			await xslt('<a data-asset-type="interactive-graphic" href="https://ig.ft.com/foo" data-width="300" data-height="200">Graphic</a>')
	...
	it('should strip if href is not https', async () => {
		expect(
			await xslt('<a data-asset-type="interactive-graphic" href="http://ig.ft.com/foo" data-width="300" data-height="200">Graphic</a>')
		).dom.to.equal('');
	});
});
